...
class ReservationTest {
    ...
    fun testGetByAdIdWithStatus() {
        ...
        val reservationsAccept = RestAssured.given().auth().oauth2(tokenJWT).get("/api/reservation/ad/${adGiven.id}?statusId=1")
                .then()
                .statusCode(200)
                .extract()
                .body()
        ...
        val reservationsAwait = RestAssured.given().auth().oauth2(tokenJWT).get("/api/reservation/ad/${adGiven.id}?statusId=2")
                .then()
                .statusCode(200)
                .extract()
                .body()
        ...
        val reservationsRefuse = RestAssured.given().auth().oauth2(tokenJWT).get("/api/reservation/ad/${adGiven.id}?statusId=3")
                .then()
                .statusCode(200)
                .extract()
                .body()
